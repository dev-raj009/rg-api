...
// ✅ Token copy buttons
// ✅ Vercel 100% crash-free (lazy init, no app.listen on Vercel)
// ✅ Render 100% working (full server + keepAlive)
// ✅ Dual platform — zero error deploy
...
if (!IS_VERCEL) {
  ...
  // Vercel mode — pre-warm attempt (non-blocking)
  ensureInit().catch(e => console.error("[Vercel pre-warm]", e.message));
}
